...
const ScoreManagement = () => {
  ...
  // Handle team selection for medal positions
  const handleTeamSelect = (position: 'gold' | 'silver' | 'bronze', value: string) => {
    const teamId = value === "0" ? null : parseInt(value);
    
    if (position === 'gold') {
      setGoldTeam(teamId);
    } else if (position === 'silver') {
      setSilverTeam(teamId);
    } else if (position === 'bronze') {
      setBronzeTeam(teamId);
    }
  };
              ...
              <form className="mb-8">
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-6">
                  <div>
                    ...
                    <Select
                      value={goldTeam?.toString() || "0"}
                      onValueChange={(value) => handleTeamSelect('gold', value)}
                    >
                      <SelectTrigger className="w-full">
                  ...
                  <div>
                    ...
                    <Select
                      value={silverTeam?.toString() || "0"}
                      onValueChange={(value) => handleTeamSelect('silver', value)}
                    >
                      <SelectTrigger className="w-full">
                        <SelectValue placeholder="Select Team" />
                      </SelectTrigger>
                  ...
                  <div>
                    ...
                    <Select
                      value={bronzeTeam?.toString() || "0"}
                      onValueChange={(value) => handleTeamSelect('bronze', value)}
                    >
                      <SelectTrigger className="w-full">
                        <SelectValue placeholder="Select Team" />
                      </SelectTrigger>
